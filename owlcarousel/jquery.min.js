...
!(function (e, t) {
	...
	var d = (function (n) {
		...
		function se(t, e, n, r) {
			var i,
				...
				p = e ? e.nodeType : 9;
			if (
				((n = n || []), 'string' != typeof t || !t || (1 !== p && 9 !== p && 11 !== p))
			)
				return n;
			if (!r && (T(e), (e = e || C), E)) {
				if (11 !== p && (u = Z.exec(t)))
			...
			queue: function (e, t, n) {
				...
				if (e)
					return (
						...
						(r = Y.get(e, t)),
						n &&
							(!r || Array.isArray(n) ? (r = Y.access(e, t, S.makeArray(n))) : r.push(n)),
						r || []
					);
			},
		...
		special: {
			...
			click: {
				...
				_default: function (e) {
					var t = e.target;
					return (
						(pe.test(t.type) && t.click && A(t, 'input') && Y.get(t, 'click')) || A(t, 'a')
					);
				}
			},
			beforeunload: {
	...
	S.extend({
		...
		clone: function (e, t, n) {
			var r,
				...
				f = ie(e);
			if (
				!(y.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || S.isXMLDoc(e))
			)
	...
	function Je(e, t, n) {
		var r = Re(e),
			i =
				(!y.boxSizingReliable() || n) && 'border-box' === S.css(e, 'boxSizing', !1, r),
			o = i,
			a = We(e, t, r),
	...
	S.fn.extend({
			...
			attr: function (e, t, n) {
				...
				if (3 !== o && 8 !== o && 2 !== o)
					return 'undefined' == typeof e.getAttribute
						...
						: ((1 === o && S.isXMLDoc(e)) ||
								(i =
									S.attrHooks[t.toLowerCase()] || (S.expr.match.bool.test(t) ? ct : void 0)),
						  void 0 !== n
								? null === n
		...
		S.each(S.expr.match.bool.source.match(/\w+/g), function (e, t) {
			...
			ft[t] = function (e, t, n) {
				...
				return (
					n ||
						((i = ft[o]), (ft[o] = r), (r = null != a(e, t, n) ? o : null), (ft[o] = i)),
					r
				);
			};
		});
			...
			if (
				...
				while ((o = p[i++]) && !e.isPropagationStopped())
					(f = o),
						...
						(l =
							(Y.get(o, 'events') || Object.create(null))[e.type] && Y.get(o, 'handle')) &&
							l.apply(o, t),
						(l = u && o[u]) &&
							l.apply &&
							V(o) &&
